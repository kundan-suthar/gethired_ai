...
import { BrainCircuit, X, LayoutDashboard } from "lucide-react";
      ...
      {activeComponent ? (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-auto p-8 flex justify-center items-start">
            <div className="w-full max-w-4xl">{activeComponent}</div>
          </div>
        </div>
      ) : (
        <div className="flex-1 flex flex-col items-center justify-center p-12 text-center space-y-6">
          ...
          <div className="space-y-2 max-w-sm">
            ...
            <p className="text-muted-foreground">
              When you ask Tambo for quizzes, graphs, or interview practice
              modules, they will appear here for you to interact with.
            </p>
          </div>

          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-background border border-border hover:bg-muted transition-colors text-sm font-medium shadow-sm"
          >
          ...
          <div className="grid grid-cols-2 gap-4 mt-4 w-full max-w-md">
            <div className="p-4 rounded-xl border border-dashed border-border bg-background/50 text-left space-y-1">
              ...
              <p className="text-sm">
                Test your technical knowledge in real-time.
              </p>
            </div>
            <div className="p-4 rounded-xl border border-dashed border-border bg-background/50 text-left space-y-1">
              ...
              <p className="text-sm">
                Visualize industry trends and salary data.
              </p>
            </div>
          </div>
        </div>
